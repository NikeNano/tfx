...
def _to_local_deployment(
  ...
  logging.info("DO NOT CHECK IN I'm here input_config: %s", input_config)
  logging.info("DO NOT CHECK IN I'm here "
               "hasattr(input_config, 'metadata_connection_config'): %s",
               hasattr(input_config, 'metadata_connection_config'))
