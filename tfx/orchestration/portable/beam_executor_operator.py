...
class BeamExecutorOperator(base_executor_operator.BaseExecutorOperator):
  ...
  def __init__(self,
    ...
    """Initialize a BeamExecutorOperator.
    ...
    """
    del platform_config
    super(BeamExecutorOperator, self).__init__(executor_spec)
  ...
  def run_executor(
    ...
    """
    context = base_executor.BaseBeamExecutor.Context(
    ...
    return python_executor_operator.PythonExecutorOperator.run_with_executor(
        execution_info, executor)
